...
const Footer = () => {
  return (
    <footer
      ...
      className="footer footer-center bg-base-300 border-t border-base-content/10 p-8 text-base-content"
    >
      <nav className="flex flex-row flex-wrap items-center justify-center gap-6 text-sm">
      ...
      <aside>
        <p data-testid="copyright-element" className="text-sm opacity-70">
          Copyright © 2026 – Frank Mendez
        </p>
      </aside>
    </footer>
  );
